...
export default {
  ...
  //按照月份获取销售额
  getOrderCountByMonth: (data) =>
    request("/admin/getOrderCountByMonth", "", data),
  //按照年份获取销售额
  getOrderCount: (year) => request("/admin/getOrderCount", "", { year }),
  //按照年份获取员的年度销售额
  getOrderByEvery: (year, pageNum) =>
    request("/admin/getOrderByEvery", "", { year, pageNum }),
  //搜索员工
  findStaffBySearch: (data, pageNum) =>
    request("/admin/findStaffBySearch", "", { pageNum, data }),
  //发布通知
  ...
  deleteNotice: (noticeId) =>
    request("/admin/deleteNotice", "", { noticeId }, "DELETE"),
  //获取已读取通知的人数
  ...
  //驳回申请
  applyTurn: (noticeId, mark) =>
    request("/admin/applyTurn", "", { noticeId, mark }, "PUT"),
  //修改信息
  handleChangeInfo: (data) =>
    request("/admin/handleChangeInfo", "", data, "PUT"),
  //修改密码
  handleChangePassword: (data) =>
    request("/admin/handleChangePassword", "", data, "PUT"),
  //获取全部管理员信息
  findAllAminInfo: (pageNum) =>
    request("/admin/findAllAminInfo", "", { pageNum }),
  //添加管理员
  addAdmin: (data) => request("/admin/addAdmin", data, "", "POST"),
  //冻结账号
  handleFreezeStatus: (adminId) =>
    request("/admin/handleFreezeStatus", "", { adminId }, "PUT"),
  //恢复账号
  handleRecoverStatus: (adminId) =>
    request("/admin/handleRecoverStatus", "", { adminId }, "PUT"),
  //改变用户为删除状态
  handleDeleteStatus: (adminId) =>
    request("/admin//handleDeleteStatus", "", { adminId }, "PUT"),
  //重置账号
  handleReset: (adminId) =>
    request("/admin/handleDeleteStatus", "", { adminId }, "PUT"),
  //删除账号
  ...
  //上传文件
  uploadFile: (url, file, fn, header) =>
    request(url, file, "", "POST", fn, header),
  //删除文件
  deleteFile: (filePath) =>
    request("/admin/deleteFile", "", { filePath }, "DELETE"),
};
